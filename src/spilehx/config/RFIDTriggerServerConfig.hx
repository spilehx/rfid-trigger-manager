...
class RFIDTriggerServerConfig {
	...
	public static var APP_ARGS:Array<ApplicationCommandArg> = [
		...
		new ApplicationCommandArg("-u", "newVersionCheck","Check for new version on start and update - true/false default true"),
		new ApplicationCommandArg("-h", "headless","Run in headless mode without UI - true/false default false")
	];
